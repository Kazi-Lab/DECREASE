...
shinyUI(navbarPage(
  title = div(
    class = "myheader",
    img(class = "imgLogo", src = "logo.png", height = "48", width = "55"),
    div(class = "decTec", "DeCREaSE"),

    div(
      class = "reference",
      tags$a(
        href = "https://www.nature.com/articles/s42256-019-0122-4",
        target = "_blank",
        tags$p("Reference")
      )
    ),
  ...
  tags$head(
    ...
    tags$script(src = "plotsurface.js"),
  ...
  div(
    ...
    column(
      ...
      div(
        ...
        div(
          id = "textseltour1",
          fluidRow(HTML(
            '<p class = "figuretext">To predict the currently selected combination: </p>'
          )),
          fluidRow(actionButton(
            "startanalysis",
            "Start",
        ...
        div(
          id = "textseltour2",
          fluidRow(HTML(
            '<p class = "figuretext">To predict all combinations (~ 1-3 min. per combination depending on server load): </p>'
          )),
          fluidRow(actionButton(
            "startanalysisall",
            "Start all",
    ...
    div(
      ...
      br(),
      br(),
      HTML("<img class='imgload' src='loadgif.gif'>")
    )
  ),
  ...
  div(
    ...
    fluidRow(
      column(
        6,
        offset = 3,
        HTML("<img src = 'main.png' class = 'mainimg' ></img>")
      ) #,
    ),
    ...
    fluidRow(column(
      ...
      offset = 2,
      HTML(
        '<p class = "maintext"><b>DECREASE</b></p> <p class = "maintext2">A method for accurate Drug Combination RESponse prEdictions. </p>'
      )
    )),
    ...
    div(
      ...
      column(
        ...
        actionButton(
          "getstarted",
          "Get started",
          style = "width:50%; border-radius:15px;position:absolute;right:10px;padding:14px;border-color: #e9ecef;",
          class = "getstartedbutton2 btn-primary btn-md",
          icon = icon("forward")
        )
      ),
      column(
        ...
        actionButton(
          "getstarted2",
          "How to use",
          style = "width:50%; border-radius:15px;position:absolute;left:10px;padding:14px;border-color: #e9ecef;);",
          class = "getstartedbutton2"
        )
      )
    )
  ),
